...
function initModels(sequelize) {
  ...
  compra.belongsTo(usuario, { as: "usuario_registro", foreignKey: "id_usuario"});
  usuario.hasMany(compra, { as: "compra_registros", foreignKey: "id_usuario"});
  compra.belongsTo(usuario, { as: "usuario_anulador", foreignKey: "id_usuario_anula"});
  usuario.hasMany(compra, { as: "compra_anuladas", foreignKey: "id_usuario_anula"});
  ...
  venta.belongsTo(usuario, { as: "usuario_registro", foreignKey: "id_usuario"});
  usuario.hasMany(venta, { as: "venta_registros", foreignKey: "id_usuario"});
  venta.belongsTo(usuario, { as: "usuario_anulador", foreignKey: "id_usuario_anula"});
  usuario.hasMany(venta, { as: "venta_anuladas", foreignKey: "id_usuario_anula"});
